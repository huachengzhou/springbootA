...
$("#text2").coolautosuggest({
	...
	<fieldset id="fieldset3" class="coolfieldset">
		<legend>Image Thumbnail And Additional Description</legend>
		<div>
			<form>
...
$("#text4").coolautosuggest({
	...
	<fieldset id="fieldset5" class="coolfieldset">
	  <legend class="new">Callback Function (New)</legend>
		<div>
			<form>
...
$("#text5").coolautosuggest({
  ...
  <i><b>onSelected</b>:function(result){
	...
	<fieldset id="fieldset6" class="coolfieldset">
		<legend>Server Side Script</legend>
		<div>
...
<span style="color: #000000; font-weight: bold;">?&gt;</span></pre>
	...
	<fieldset id="fieldset7" class="coolfieldset">
		...
		<div>
			<p>Thank you for using this plugin. You can rate this plugin <a href="http://plugins.jquery.com/project/coolautosuggest" target="_blank">here</a>.</p>
			<p>Please consider donating to support the improvement of this plugin.</p>
			<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
			<input type="hidden" name="cmd" value="_s-xclick">
			<input type="hidden" name="hosted_button_id" value="ZMA2NAWBAMRBL">
